...
if (!$sql->execute()) {
    $_SESSION['msg'] = "<p class='alert alert-danger'><i class='fa-solid fa-circle-exclamation'></i> Erro! Caixa não adicionado. Tente novamente.</p>";
    header("Location: index.php");
    exit;
}

$_SESSION['msg'] = "<p class='alert alert-success'><i class='fa-solid fa-thumbs-up'></i> Sucesso! Caixa adicionado.</p>";
header("Location: index.php");
exit;
